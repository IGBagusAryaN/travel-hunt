    ...
    <div>
      ...
      <div className="relative h-[100vh]">
          ...
          <p className="text-white text-center text-[16px]  absolute top-143 left-26 max-w-[290px]">
            {" "}
            Let the journey guide you to places your heart has always dreamed about exploring...
          </p>
        </div>
        ...
        <div className="pt-32 w-[40%]">
          ...
          <form action="" className="mt-10 " onSubmit={handleSubmit(onSubmit)}>
            <div className="relative z-0 w-full mb-5 group">
              ...
              />
              {errors.email && (
                <div className="text-red-400 text-sm mt-2">{errors.email.message}</div>
              )}
            ...
            <div className="relative z-0 w-full mb-5 group">
              ...
              />
              {errors.password && (
                <div className="text-red-400 text-sm mt-2">{errors.password.message}</div>
              )}
            ...
            <div className="w-full text-center my-4">
              <button className="border border-gray-200 bg-[#4B83FE] w-full p-3 text-white font-bold rounded-sm" type="submit" disabled={isLoading}>
             Login
              </button>
            </div>
          </form>
          <span>
            ...
            <Link to={"/sign-up"} className="ml-1 text-[#4B83FE] hover:text-[#4b84fea9]">
              Sign up
            </Link>
          </span>
        </div>
